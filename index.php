    ...
    <nav class="menu">
        ...
        <div class="menu-options">
            ...
            if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) {
                ...
                echo '<a href="cadastrar.php" class="menu-button" onclick="redirectWithFade(event, \'cadastrar.php\');">Cadastrar</a>';
                echo '<a href="logar.php" class="menu-button" onclick="redirectWithFade(event, \'logar.php\');">Logar</a>';
            }
            ?>
        ...
        <div class="carousel">
            ...
            <div class="carousel-slide">
                <div class="circle-container">
                    ...
                    <div class="circle-content">
                        <img src="perifericos/mouse.png" alt="Periférico">
                    </div>
                </div>
                <div class="info">
                    <h2>Mouse Gamer<br>
            ...
            <div class="carousel-slide">
                <div class="circle-container">
                    <div class="circle-blur"></div> 
                    <div class="circle-content">
                        <img src="perifericos/teclado1.jpg" alt="Periférico">
                    </div>
                </div>
                <div class="info">
            ...
            <div class="carousel-slide">
                <div class="circle-container">
                    <div class="circle-blur"></div> 
                    <div class="circle-content">
                        <img src="perifericos/headset.png" alt="Periférico">
                    </div>
                </div>
                <div class="info">
                    <h2>HyperX Cloud <br>
